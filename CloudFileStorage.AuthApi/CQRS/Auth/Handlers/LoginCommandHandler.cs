...
{
    public class LoginCommandHandler : IRequestHandler<LoginCommand, ServiceResponse<AuthResponseDto>>
    {
        ...
        public async Task<ServiceResponse<AuthResponseDto>> Handle(LoginCommand request, CancellationToken cancellationToken)
        {
